...
class Users implements UserInterface, PasswordAuthenticatedUserInterface
{
    ...
    public function getProfill(): ?Profil
    {
        return $this->profill;
    }

    public function setProfill(Profil $profill): static
    {
        // set the owning side of the relation if necessary
        if ($profill->getUser() !== $this) {
            $profill->setUser($this);
        }
